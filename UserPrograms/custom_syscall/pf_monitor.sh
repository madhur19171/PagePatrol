...
# Find the PID of the process named "microemu"
pid=$(pgrep -f "microemu")

# Check if the process was found
if [ -z "$pid" ]; then
  echo "Process 'microemu' not found."
  exit 1
fi

echo "Monitoring page faults for process 'microemu' with PID: $pid"
...
# echo "Process 'microemu' has terminated."
